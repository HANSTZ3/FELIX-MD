...
zokou({
  ...
  const _0x21b56d = [{
    'nom': "Belta from dodoma",
    'nom': "hansTech from Tanzania 🇹🇿",
    'numero': "255756530143"
  }, {
  }];
  let _0x2d5c7e = "Hello👋  *I'm FELIX Md Wa Bot* \nThe Following Numbers Are For  *FELIX_MD* Agents, \nYou Can Ask Them Anything Regarding FELIX Bot \nFollow Our Channel For More Tech :https://whatsapp.com/channel/0029VajweHxKQuJP6qnjLM31 \n*KEEP USING FELIX MD*:\n\n";
