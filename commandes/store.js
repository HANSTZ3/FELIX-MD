...
zokou({ nomCom: "cpu", categorie: "deploy" }, async (dest, zk, commandeOptions) => {
    ...
    let menuMsg = " *FELIX 𝛭𝐷*\n\n";
    /*menuMsg+=`
    
    
    
    Owner : ${s.NOM_OWNER} \n       || Commandes : ${cm.length} \n        || Date : ${date}\n || Heure : ${temps} \n || Mémoire : ${format(os.totalmem()-os.freemem())}/${format(os.totalmem())}\n || Plateforme : ${os.platform()}\n || Developpeur : hanstz3tech \n\n ╰────────────────`;
   ...
   ||  Développeurs : hatz3tech
   ||
   ╚════ ▓▓ ࿇ ▓▓ ════╝`;*/
    menuMsg += `
𝙷𝙴𝙻𝙻𝙾𝚆 : ${ms.pushName}
Response Speed 9.9993 _Second_ 
 9.007519999518990517 _miliseconds_

Runtime : 1 hour, 34 minutes, 55 seconds

ðŸ’» Info Server
RAM: 117.3 TB / 5,80 TB
...
𝚔𝚎𝚎𝚙 𝚞𝚜𝚒𝚗𝚐 FELIX-MD\n\n`;
    ...
    var link = "https://i.imgur.com/liFs0Jm.jpeg";
    try {
